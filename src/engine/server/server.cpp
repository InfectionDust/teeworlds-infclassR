...
/* INFECTION MODIFICATION START ***************************************/
	...
	SetFireDelay(INFWEAPON_CHAINING_LASER, GetFireDelay(INFWEAPON_LASER));
	...
	SetAmmoRegenTime(INFWEAPON_CHAINING_LASER, 7000);
	...
	SetMaxAmmo(INFWEAPON_CHAINING_LASER, 10);
